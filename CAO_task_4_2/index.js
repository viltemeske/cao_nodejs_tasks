...
app.get("/people", (req, res) => {
  ...
  // 2. Dinaminis GET route, kur URL turės automobilio markę ir pagal ją prafiltruos, ir grąžins tik tuos žmones, kurie turi šį automobilį.
...
// 3. Dinamins GET route, kuris priims vartotojo id ir pagal jį grąžins atitinkamą vartotojo objektą.
...
app.listen(8081, () => console.log("The server is running on port 8081"));
